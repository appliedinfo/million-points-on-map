(function (t) {
    t.Parse = t.Parse || {}, t.Parse.VERSION = "js1.2.13"
})(this), function () {
    var t = this, e = t._, n = {}, i = Array.prototype, r = Object.prototype, s = Function.prototype, a = i.push,
        o = i.slice, u = i.concat, c = r.toString, l = r.hasOwnProperty, h = i.forEach, f = i.map, d = i.reduce,
        p = i.reduceRight, _ = i.filter, m = i.every, v = i.some, g = i.indexOf, b = i.lastIndexOf, y = Array.isArray,
        w = Object.keys, O = s.bind, x = function (t) {
    ...
    var E = x.each = x.forEach = function (t, e, i) {
    ...
    x.reduce = x.foldl = x.inject = function (t, e, n, i) {
        ...
        if (null == t && (t = []), d && t.reduce === d)return i && (e = x.bind(e, i)), r ? t.reduce(e, n) : t.reduce(e);
        ...
        var r = arguments.length > 2;
        if (null == t && (t = []), p && t.reduceRight === p)return i && (e = x.bind(e, i)), r ? t.reduceRight(e, n) : t.reduceRight(e);
        var s = t.length;
        if (s !== +s) {
            var a = x.keys(t);
            s = a.length
    ...
    var A = x.some = x.any = function (t, e, i) {
        e || (e = x.identity);
        var r = !1;
    ...
    x.contains = x.include = function (t, e) {
        ...
        var n = o.call(arguments, 2), i = x.isFunction(e);
        ...
        return x.isEmpty(e) ? n ? null : [] : x[n ? "find" : "filter"](t, function (t) {
        ...
        return E(t, function (t, r, s) {
            ...
            a >= i.computed && (i = {value: t, computed: a})
        }), i.value
        ...
        return E(t, function (t, r, s) {
            var a = e ? e.call(n, t, r, s) : t;
            i.computed > a && (i = {value: t, computed: a})
        }), i.value
    ...
    x.sortBy = function (t, e, n) {
        var i = j(e);
        return x.pluck(x.map(t, function (t, e, r) {
            return {value: t, index: e, criteria: i.call(n, t, e, r)}
        }).sort(function (t, e) {
    ...
    x.groupBy = function (t, e, n) {
        ...
        return t ? x.isArray(t) ? o.call(t) : t.length === +t.length ? x.map(t, x.identity) : x.values(t) : []
    }, x.size = function (t) {
    ...
    var P = function (t, e, n) {
        return E(t, function (t) {
            x.isArray(t) ? e ? a.apply(n, t) : P(t, e, n) : n.push(t)
        }), n
    };
    x.flatten = function (t, e) {
        return P(t, e, [])
    }, x.without = function (t) {
        return x.difference(t, o.call(arguments, 1))
    }, x.uniq = x.unique = function (t, e, n, i) {
        x.isFunction(e) && (i = n, n = e, e = !1);
        var r = n ? x.map(t, n, i) : t, s = [], a = [];
        return E(r, function (n, i) {
            (e ? i && a[a.length - 1] === n : x.contains(a, n)) || (a.push(n), s.push(t[i]))
        }), s
    }, x.union = function () {
        return x.uniq(u.apply(i, arguments))
        ...
        for (var t = o.call(arguments), e = x.max(x.pluck(t, "length")), n = Array(e), i = 0; e > i; i++)n[i] = x.pluck(t, "" + i);
        return n
        ...
        if (t.bind === O && O)return O.apply(t, o.call(arguments, 1));
        ...
        var e = o.call(arguments, 1);
        return 0 === e.length && (e = x.functions(t)), E(e, function (e) {
            t[e] = x.bind(t[e], t)
        }), t
        ...
        return x.delay.apply(x, [t, 1].concat(o.call(arguments, 1)))
    ...
    var C = function (t, e, n, i) {
        ...
        var a = 0, o = !0;
        if ("[object Array]" == r) {
            if (a = t.length, o = a == e.length)for (; a-- && (o = C(t[a], e[a], n, i)););
        } else {
            var u = t.constructor, l = e.constructor;
            if (u !== l && !(x.isFunction(u) && u instanceof u && x.isFunction(l) && l instanceof l))return !1;
            for (var h in t)if (x.has(t, h) && (a++, !(o = x.has(e, h) && C(t[h], e[h], n, i))))break;
            if (o) {
                for (h in e)if (x.has(e, h) && !a--)break;
                o = !a
            }
        }
    ...
    var R = {escape: {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#x27;", "/": "&#x2F;"}};
    R.unescape = x.invert(R.escape);
    var I = {
        escape: RegExp("[" + x.keys(R.escape).join("") + "]", "g"),
        unescape: RegExp("(" + x.keys(R.unescape).join("|") + ")", "g")
    };
    x.each(["escape", "unescape"], function (t) {
        ...
        E(x.functions(t), function (e) {
            var n = x[e] = t[e];
            x.prototype[e] = function () {
                var t = [this._wrapped];
                return a.apply(t, arguments), M.call(this, n.apply(x, t))
            }
        })
    };
    var U = 0;
    ...
    x.template = function (t, e, n) {
        ...
        var r = RegExp([(n.escape || k).source, (n.interpolate || k).source, (n.evaluate || k).source].join("|") + "|$", "g"),
            s = 0, a = "__p+='";
    ...
    x.mixin(x), E(["pop", "push", "reverse", "shift", "sort", "splice", "unshift"], function (t) {
        var e = i[t];
    ...
    e.serverURL = "https://api.parse.com", "undefined" != typeof process && process.versions && process.versions.node && (e._isNode = !0), e.initialize = function (t, n, i) {
        ...
        var e = RegExp("^([0-9]{1,4})-([0-9]{1,2})-([0-9]{1,2})T([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2})(.([0-9]+))?Z$"),
            n = e.exec(t);
        if (!n)return null;
        var i = n[1] || 0, r = (n[2] || 1) - 1, s = n[3] || 0, a = n[4] || 0, o = n[5] || 0, u = n[6] || 0,
            c = n[8] || 0;
        ...
        var n = t.route, i = t.className, r = t.objectId, s = t.method, a = t.useMasterKey, o = t.sessionToken,
            u = t.data;
        ...
        if (t instanceof e.File) {
            ...
            return {__type: "File", name: t.name(), url: t.url()}
        }
        if (r.isObject(t)) {
            var s = {};
    ...
    e.Analytics = e.Analytics || {}, n.extend(e.Analytics, {
        track: function (t, i) {
            if (!t || 0 === t.trim().length)throw"A name for the custom event must be provided";
            return n.each(i, function (t, e) {
                if (!n.isString(e) || !n.isString(t))throw'track() dimensions expects keys and values of type "string".'
            }), e._request({route: "events", className: t, method: "POST", data: {dimensions: i}})
        }
    })
}(this), function (t) {
    t.Parse = t.Parse || {};
    ...
    e.Events = {
        on: function (t, e, i) {
            ...
            if (s = this._callbacks) {
                ...
                for (t = t ? t.split(n) : _.keys(s), r = t.shift(); r;)if (a = s[r], delete s[r], a && (e || i)) {
    ...
    e.GeoPoint = function (t, i) {
        ...
        toJSON: function () {
            ...
            var e = Math.PI / 180, n = this.latitude * e, i = this.longitude * e, r = t.latitude * e,
                s = t.longitude * e, a = n - r, o = i - s, u = Math.sin(a / 2), c = Math.sin(o / 2),
    ...
    e.ACL = function (t) {
        var i = this;
        if (i.permissionsById = {}, n.isObject(t))if (t instanceof e.User) i.setReadAccess(t, !0), i.setWriteAccess(t, !0); else {
    ...
    e.Op = function () {
        ...
        _initialize: function (t, i) {
            ...
            var t = null, e = null, i = this, r = function (t) {
                return {__type: "Pointer", className: i._targetClassName, objectId: t}
            }, s = null;
    ...
    var e = t.Parse, n = e._, i = function (t) {
        ...
        return e.length = Math.ceil(t.length / 3), n.times(e.length, function (n) {
            var r = t[3 * n], s = t[3 * n + 1] || 0, a = t[3 * n + 2] || 0, o = t.length > 3 * n + 1,
                u = t.length > 3 * n + 2;
        ...
        return r.onloadend = function () {
            if (2 !== r.readyState)return i.reject(new e.Error(-1, "Error reading file.")), void 0;
    ...
    e.File = function (t, i, o) {
        ...
        if (n.isArray(i)) this._source = e.Promise.as(r(i), c); else if (i && i.base64) {
        ...
        } else if ("undefined" != typeof File && i instanceof File) this._source = a(i, o); else if (n.isString(i))throw"Creating a Parse.File from a String is not yet supported."
    }, e.File.prototype = {
        name: function () {
            return this._name
        }, url: function () {
    ...
    e.Object = function (t, i) {
        ...
        if (r && (t = n.extend({}, r, t)), i && i.collection && (this.collection = i.collection), this._serverData = {}, this._opSetQueue = [{}], this.attributes = {}, this._hashedJSON = {}, this._escapedAttributes = {}, this.cid = n.uniqueId("c"), this.changed = {}, this._silent = {}, this._pending = {}, !this.set(t, {silent: !0}))throw Error("Can't create an invalid Parse.Object");
        ...
        return n = n || {}, e.Object._deepSaveAsync(t, {useMasterKey: n.useMasterKey})._thenRunCallbacks(n)
                ...
                return e._request({
                    ...
                    data: {
                        requests: n.map(t, function (t) {
                            return {method: "DELETE", path: "/1/classes/" + t.className + "/" + t.id}
                        })
                    }
                })
            }).then(function (n) {
                e._arrayEach(t, function (t, a) {
                    if (n[a].success && i.wait) r(t); else if (n[a].error) {
        ...
        _existed: !1, initialize: function () {
            ...
            f._refreshCache();
            var d = [], p = [];
            return e.Object._findUnsavedChildren(f.attributes, d, p), d.length + p.length > 0 ? e.Object._deepSaveAsync(this.attributes, {useMasterKey: o.useMasterKey}).then(function () {
    ...
    e.Collection = function (t, e) {
        ...
        model: e.Object, initialize: function () {
            ...
            if (this.length += a, s = e._isNullOrUndefined(i.at) ? this.models.length : i.at, this.models.splice.apply(this.models, [s, 0].concat(t)), this.comparator && this.sort({silent: !0}), i.silent)return this;
            ...
            return r.find({useMasterKey: t.useMasterKey}).then(function (e) {
    ...
    e.User = e.Object.extend("_User", {
        _isCurrentUser: !1, _mergeMagicFields: function (t) {
            ...
            return t.authenticate({
                success: function (t, e) {
                    o._linkWith(t, {authData: e, success: i.success, error: i.error}).then(function () {
                        u.resolve(o)
                    })
                }, error: function (t, e) {
            ...
            var n = this;
            t = t || {};
            var i = e._request({route: "login", method: "GET", useMasterKey: t.useMasterKey, data: this.toJSON()});
            return i.then(function (t, e, i) {
                var r = n.parse(t, e, i);
        ...
        logIn: function (t, n, i) {
            ...
            return r._finishFetch({username: t, password: n}), r.logIn(i)
        },
        become: function (t, n) {
            n = n || {};
    ...
    e.Query = function (t) {
        ...
        get: function (t, n) {
            ...
            return i = i || {}, new e.Collection(t, n.extend(i, {model: this.objectClass, query: this}))
        }, skip: function (t) {
            ...
            var i = n.toJSON();
            return i.className = n.className, this._addCondition(t, "$select", {key: e, query: i}), this
        }, doesNotMatchKeyInQuery: function (t, e, n) {
            var i = n.toJSON();
            return i.className = n.className, this._addCondition(t, "$dontSelect", {key: e, query: i}), this
        }, _orQuery: function (t) {
            ...
            return n instanceof e.GeoPoint || (n = new e.GeoPoint(n)), i instanceof e.GeoPoint || (i = new e.GeoPoint(i)), this._addCondition(t, "$within", {$box: [n, i]}), this
        }, include: function () {
            var t = this;
    ...
    e.History.started = !1, n.extend(e.History.prototype, e.Events, {
        interval: 50, getHash: function (t) {
            ...
            var s = this.getFragment(), a = document.documentMode,
    ...
    e.Installation = e.Object.extend("_Installation"), e.Push = e.Push || {}, e.Push.send = function (t, n) {
        ...
        var i = e._request({route: "push", method: "POST", data: t, useMasterKey: n.useMasterKey});
        return i._thenRunCallbacks(n)
    }
}(this);